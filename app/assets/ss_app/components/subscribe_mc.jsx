export default class SubscribeMC extends React.Component {
	constructor(props) {
    super();
    this.state = {
      url: "https://world.us10.list-manage.com/subscribe/post?u=b9038b47308ee048607329e4a&amp;id=efc46b047d",
      messages:
      {
        sending: "Данные отправляются...",
        success: "Вам было отправлено письмо для подтвеждения",
        error: "Возникла непредвиденная ошибка",
        empty: "Вам нужно ввести адрес электронной почты",
        duplicate: "Вы слишком много раз пытались подписаться",
        button: "OK"
      },
      fields:
      {
  ...
  componentDidMount() {
    if (window.locale == "en") {
    	this.setState({
    		url: "https://world.us10.list-manage.com/subscribe/post?u=b0b81934061263ad80015c26c&amp;id=549b2aa648",
        messages:
        {
          sending: "Sending...",
